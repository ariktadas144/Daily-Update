#Time Series Basics – Trend, Seasonality, Moving Average; ARIMA/SARIMA, FB Prophet
...
for i, row in final_eval.iterrows():
    ...
    for j, (bar, value) in enumerate(zip(bars, model_values)):
        ...
        ax.text(bar.get_x() + bar.get_width()/2., height + height*0.01, f'{value:.3f}', ha='center', va='bottom', fontweight='bold', fontsize=10)
